...
local CN_soundDescriptions = {
	...
	["CHAT_MSG_BN_WHISPER_PLAYER_OFFLINE"] = "When you receive an auto-response for the battle.net whisper target being offline",
	...
	["CHAT_MSG_INSTANCE_CHAT"] = "When you receive a message in instance chat, such as when you're in a match-made dungeon or raid.",
	["CHAT_MSG_INSTANCE_CHAT_LEADER"] = "When you receive a message in instance chat from the instance leader, such as when you're in a match-made dungeon or raid.",
